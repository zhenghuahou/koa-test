...
app.use(function *(next){
  // (2) 进入 logger 中间件
  var start = +new Date;
  console.log('第二个start:',start);

  yield next;
  // (4) 再次进入 logger 中间件，记录2次通过此中间件「穿越」的时间
  var ms = new Date - start;
    console.log('第二个start回来:',ms);
...
/*
输出顺序:
第一个start: 1485056135982
第二个start: 1485056135992
第三个 start: 1485056135992  this.ip: ::ffff:10.7.248.201
第三个 start回来
第二个start回来: 7
GET /index - 7
第一个start回来: 17
